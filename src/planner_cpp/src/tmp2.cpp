...
using Position = std::tuple<double, double, int>; // Tuple (x, y, index)

// Function to compute the Euclidean distance between two positions
double distance_between(const Position& a, const Position& b) {
...
std::pair<double, std::vector<int>> tsp_shortest_path(const Position& start, const Position& goal, const std::vector<Position>& intermediates) {
...
int main() {
    // Example usage:
    Position start{0.0, 0.0, 0}; // Starting position
    Position goal{10.0, 10.0, -1}; // Goal position

    std::vector<Position> intermediates1 = {
        {10.0, 0.0, 5},
        {10.0, 5.0, 6},
        {5.0, 0.0, 4},
        {3.0, 0.0, 3},
    ...
    std::vector<Position> intermediates2 = {
        {1.0, 1.0, 1},
        {8.0, 8.0, 8},
        {4.0, 4.0, 4},
        {5.0, 5.0, 5},
